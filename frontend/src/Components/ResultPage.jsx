  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFFBDE] via-[#91C8E4] to-[#4682A9] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="px-6 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-600">Current Job</h3>
                  <p className="mt-1 text-lg text-gray-800">{data.current_job}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-medium text-gray-600">Target Job Title</h3>
                  <p className="mt-1 text-lg text-gray-800">{data.required_job}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-600">Current Skills</h3>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden">
          <div className="px-6 py-8">
            <h3 className="text-2xl font-bold text-gray-800 mb-6">Your Personalized Roadmap</h3>
