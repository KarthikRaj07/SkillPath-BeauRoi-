    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FFFBDE] via-[#91C8E4] to-[#4682A9] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {/* ML Roadmap Card */}
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden hover:shadow-green-200/50 transition-all duration-300 transform hover:scale-[1.02]">
            <div className="p-6">
              <div className="flex items-center justify-center h-12 w-12 rounded-xl bg-gradient-to-r from-yellow-400 to-green-400 text-white mb-4">
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2" fill="none" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h4l2 4" />
                </svg>
              </div>
              <h3 className="text-lg font-medium text-gray-800 mb-2">Machine Learning Roadmap</h3>
              <p className="text-gray-600 mb-4">
                Step into ML with a practical, project-based roadmap
              </p>
              <button
                onClick={() => navigate('/ml')}
                className="w-full inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-yellow-400 to-green-400 text-white font-semibold rounded-xl hover:from-yellow-500 hover:to-green-500 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
              >
                Start Learning
              </button>
            </div>
